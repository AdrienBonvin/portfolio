...
export const LangToggle = () => {
  ...
  return (
    <div className="pointer-events-auto fixed top-3 right-3 z-40 flex gap-1 rounded-full border border-white/15 bg-black/30 p-0.5 backdrop-blur-sm md:top-5 md:right-5 md:p-1">
      {OPTIONS.map((option) => (
        <button
          key={option}
          type="button"
